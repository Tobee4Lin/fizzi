      ...
      <div className="grid">
        <div className="grid h-screen place-items-center">
          <div className="grid auto-rows-min place-items-center text-center">
            <h1 className="hero-header text-7xl leading-[.8] font-black text-orange-500 uppercase md:text-[9rem] lg:text-[13em]">
              <TextSplitter
        ...
        <div className="text-side relative z-[80] grid h-screen items-center gap-4 md:grid-cols-2">
          {/* md:hidden类意为屏幕宽度大于768px时隐藏该元素，
          因此当isDesktop为false时（屏幕宽度小于768px）才会显示下述图片 */}
          <PrismicNextImage
